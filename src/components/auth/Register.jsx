...
import { User, Home, Lock, CheckCircle, ChevronRight, ChevronLeft, UserPlus } from 'lucide-react';
        ...
        return (
          <div className='flex flex-col gap-2'>
            <div className="text-center pt-3 pb-4">
              ...
              <p className="text-gray-600">Crie uma senha segura para proteger sua conta</p>
            </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg max-h-[90vh] overflow-y-auto">
          {/* Header */}
          <div className="text-center mb-8 flex flex-col gap-3">
